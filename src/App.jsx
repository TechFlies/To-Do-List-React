          ...
          >
            {theme === 'neon' && (
              <>
                ...
                <div className="pointer-events-none absolute inset-0 rounded-[26px] ring-1 ring-white/10" />
                        ...
                        <header className="px-7 pt-7 pb-6 flex flex-col gap-6">
              <div className="flex items-center justify-between">
                <div>
                  <h1
                    className={`font-extrabold tracking-tight flex items-center gap-2 ${
                      theme === 'neon'
                        ? 'text-4xl text-white bg-gradient-to-r from-fuchsia-400 via-cyan-300 to-indigo-400 bg-clip-text text-transparent drop-shadow-[0_2px_12px_rgba(59,130,246,.35)]'
                  ...
                  <p
                    className={`${
                      theme === 'neon' ? 'text-white/85' : 'text-slate-300'
                    } text-sm`}
                  >
                    Manage your todos
                  </p>
                ...
                <button
                  ...
                  } inline-flex items-center gap-2 rounded-2xl px-4 py-2 text-sm border transition`}
                  onClick={() =>
              ...
              <TodoForm query={query} setQuery={setQuery} />
            </header>
            ...
            <div className="px-6 pb-6">
              {filtered.length === 0 ? (
                ...
                >
                  <p className="text-sm">
                    No matching tasks. Add or adjust your filters.
                  </p>
                </div>
              ) : (
              ...
              <div className="mt-6 flex flex-col sm:flex-row gap-3 sm:items-center sm:justify-between">
                <div
                  className={`${
                    theme === 'neon' ? 'text-white/80' : 'text-slate-300'
                  } text-sm`}
                >
                ...
                <div className="flex items-center gap-2">
                  {['all', 'active', 'completed'].map((f) => (
                    <button
                      ...
                      className={`${
                        filter === f
                          ? 'bg-gradient-to-r from-fuchsia-500 to-cyan-500 text-white border-transparent'
                          : theme === 'neon'
